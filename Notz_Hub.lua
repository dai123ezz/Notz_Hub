...
local Window = Fluent:CreateWindow({
    Title="Notz_Hub [ Premium ]",
    SubTitle="  by MinhDaiDz", 
    TabWidth=160, 
    Theme="Notz_Hub",
    Acrylic=false,
...
toggleButton.Image = "rbxassetid://121087197254040"
...
local Tabs = {
  Main = Window:AddTab({Title = "Tab Farming", Icon = "rbxassetid://121087197254040"}),
  Settings = Window:AddTab({Title = "Tab Setting Farm", Icon = "rbxassetid://121087197254040"}),
  Melee = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "rbxassetid://121087197254040"}),
  Quests = Window:AddTab({Title = "Tab Items Farm", Icon = "rbxassetid://121087197254040"}),
  SeaEvent = Window:AddTab({Title = "Tab Sea Events", Icon = "rbxassetid://121087197254040"}),
  Mirage = Window:AddTab({Title = "Tab Mirage + RaceV4", Icon = "rbxassetid://121087197254040"}),
  Drago = Window:AddTab({Title = "Tab Drago Dojo", Icon = "rbxassetid://121087197254040"}),
  Prehistoric = Window:AddTab({Title = "Tab Prehistoric", Icon = "rbxassetid://121087197254040"}),
  Raids = Window:AddTab({Title = "Tab Raid", Icon = "rbxassetid://121087197254040"}),
  Combat = Window:AddTab({Title = "Tab Combat PVP", Icon = "rbxassetid://121087197254040"}),
  Travel = Window:AddTab({Title = "Tab Teleport", Icon = "rbxassetid://121087197254040"}),
  Fruit = Window:AddTab({Title = "Tab Fruits", Icon = "rbxassetid://121087197254040"}),
  Shop = Window:AddTab({Title = "Tab Shop", Icon = "rbxassetid://121087197254040"}),
  Misc = Window:AddTab({Title = "Tab Misc", Icon = "rbxassetid://121087197254040"})
}
...
Tabs.Main:AddSection("Minh Đại Đẹp Zai Hẹ Hẹ")
